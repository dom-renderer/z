...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($defaults as $slug => $column) {
            $setting = TicketSetting::bySlug($slug);
    ...
    public function getDefaults()
    {
        return [
             ...
             */
            'master_template' => 'ticket.layouts.master',
...
//            'admin_ids' => [1],
             ...
             */
            'summernote_options_json_file' => 'resources\views\ticket\json\summernote_init.json',
             ...
             */
            'routes' => base_path('routes').'/ticket.php',
