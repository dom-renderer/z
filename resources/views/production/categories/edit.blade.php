...
@section('content')
    <div class="bg-light p-4 rounded">
        ...
        <div class="container mt-4">
            <form method="POST" id="updateCatForm" action="{{ route('production.categories.update', $id) }}"> @csrf @method('PUT')
            ...
            $('#sbmt-btn').on('click', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.count > 0) {
                            Swal.fire({
                                title: `This category has ${response.count} sub-categories. Are you sure you want update the parent category?`,
