...
@section('content')
    <div class="bg-light p-4 rounded">
        ...
        <form method="GET" action="" id="checklistImport" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="checklist" class="form-label"> Checklist <span class="text-danger"> * </span> </label>
                ...
                @else
                <select name="checklist" id="clist2" required readonly>
