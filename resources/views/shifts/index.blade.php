    ...
    <div class="bg-light p-4 rounded">
        ...
        <div class="lead">
            ...
            @if (auth()->user()->can('shifts.create'))
                <a href="{{ route('shifts.create') }}" class="btn btn-primary btn-sm float-end">Add Shift</a>
            @endif
        </div>
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="users-tab-pane" role="tabpanel" aria-labelledby="users-tab" tabindex="0">
                <table class="table table-striped" id="shift-table" cellspacing="0" width="100%">
                    <thead>
                    <tr>
                        <th>Title</th>
                        <th>Start</th>
...
<script>
    $(document).ready(function($){
        ...
        let table = new DataTable('#shift-table', {
