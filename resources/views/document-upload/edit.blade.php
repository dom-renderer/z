        ...
        <div class="container mt-4">
            ...
            <form method="POST" action="{{ route( 'document-upload.update', encrypt( $documentupload->id ) ) }}" id="documentUploadForm" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control zp_datepicker" placeholder="Select Expire Date" name="zp_expiry_date" id="zp_expiry_date" autocomplete="off" value="{{ old( 'zp_expiry_date', $documentupload->expiry_date ) }}">
