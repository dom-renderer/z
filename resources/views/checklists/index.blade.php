    ...
    <div class="bg-light p-4 rounded">
        ...
        <div class="lead">
            ...
            @if(auth()->user()->can('multi-checklist-import'))
                <a href="{{ route('multi-checklist-import') }}" class="btn btn-success btn-sm float-end">Multi - Checklist Import</a>
            @endif
            @if (auth()->user()->can('checklists.create'))
                <a href="{{ route('checklists.create') }}" class="btn btn-primary btn-sm float-end me-2">Add Template</a>
            @endif
        </div>
