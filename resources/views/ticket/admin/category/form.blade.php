...
<div class="form-group">
    ...
    <input class="form-control" name="color" type="color" @if(isset($category->color)) value="{{$category->color}}" @else value="#000000" @endif" id="color">
</div>

{!! link_to_route($setting->grab('admin_route').'.category.index', "Back", null, ['class' => 'btn btn-link']) !!}
@if(isset($category))
