...
<div class="p-4 rounded">
    ...
    <div class="myPage">
        <div class="center">
            ...
            @if($isFound)
                <div class="text">Access to this page is restricted</div>
            @else
                <div class="text">Oops. The page you're looking for doesn't exist.</div>
            @endif
            <a class="button" href="{{url('/')}}">Back Home</a>
        </div>
        <div class="by">
            &copy; {{date('Y')}} 
            <a class="byLink" href="{{url('/')}}" target="_blank">{{config('app.name')}}</a>. All Rights Reserved
        </div>
    </div>
