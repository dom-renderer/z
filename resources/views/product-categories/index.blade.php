...
@section('content')
    ...
    <div class="bg-light p-4 rounded">
        ...
        <div class="lead">
            {{ $page_description }}
            @if (auth()->user()->can('product-categories.create'))
                <a href="{{ route('product-categories.create') }}" class="btn btn-primary btn-sm float-end">Add Category</a>
            @endif
        </div>
...
<script>
    $(document).ready(function($){
        ...
        let table = new DataTable('#role-table', {
