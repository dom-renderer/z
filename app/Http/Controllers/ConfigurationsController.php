...
class ConfigurationsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('ticket.admin.configuration.index', compact('configurations', 'configurations_by_sections', 'u', 'setting', 'tools', 'master', 'email', 'editor_enabled', 'codemirror_enabled', 'codemirror_theme', 'editor_locale', 'editor_options', 'include_font_awesome'));
    }
    ...
    public function create()
    {
        ...
        $include_font_awesome = TicketSetting::grab('include_font_awesome');
        /** all needed vars end */
        return view('ticket.admin.configuration.create', compact('u', 'setting', 'tools', 'master', 'email', 'editor_enabled', 'codemirror_enabled', 'codemirror_theme', 'editor_locale', 'editor_options', 'include_font_awesome'));
    }
    ...
    public function edit($id)
    {
        ...
        $should_serialize = TicketSetting::is_serialized($configuration->value);
        $default_serialized = TicketSetting::is_serialized($configuration->default);
        /** all needed vars start */
        $u = Agent::find(auth()->user()->id);
        $setting = new TicketSetting();
        $tools = new ToolsController();
        ...
        $include_font_awesome = TicketSetting::grab('include_font_awesome');
        /** all needed vars end */
        return view('ticket.admin.configuration.edit', compact('configuration', 'should_serialize', 'default_serialized', 'u', 'setting', 'tools', 'master', 'email', 'editor_enabled', 'codemirror_enabled', 'codemirror_theme', 'editor_locale', 'editor_options', 'include_font_awesome'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->serialize) {
            ...
            // if (!Auth::attempt($request->only('password'), false, false)) {
                return back()->withErrors(["Authentication has been failed"]);
            }
        ...
        Session::flash('status', "The setting {$request->name} has been updated successfully.");
