                    ...
                    e.exports = (function (e) {
                        ...
                        function (e, t, r) {
                            ...
                            var o =
                                ...
                                i = r(8),
                                l = { extension: ".lang", location: "/", langs: ["en-US"], locale: "en-US", override: {} },
                                a = (t.I18N = (function () {
                                    function e() {
        ...
        (o.m = t),
            ...
            (function () {
                ...
                const ye = {
                        ...
                        allowStageSort: !0,
                        append: !1,
                        controlOrder: ["radio-group", "file", "checkbox-group", "checkbox", "hidden", "select", "number", "date", "text", "textarea", "button", "autocomplete", "paragraph", "header"],
                    ...
                    class extends be {
                        ...
                        build() {
                            const e = [],
                                ...
                                c = i.replace("-group", ""),
                                f = "select" === i;
                            if (((d.multiple || "checkbox-group" === i) && (d.name = d.name + "[]"), ("checkbox-group" === i || "radio-group" === i) && d.required)) {
                                const e = this,
                        ...
                        groupRequired() {
                            const e = this.element.getElementsByTagName("input"),
                                t = this.element.querySelectorAll("input:not([type=text])"),
                                r = this.element.querySelector(".other-option"),
                                o = this.element.querySelector(".other-val"),
                                n = () => {
                                    const e = [].some.call(t, (e) => e.checked);
                                    ((e, t, r, o) => {
                                        [].forEach.call(e, (e) => {
                                            o ? e.removeAttribute("required") : e.setAttribute("required", "required"),
                                                ((e, t) => {
                                                    const r = be.mi18n("minSelectionRequired", 1);
                                                    t ? e.setCustomValidity("") : e.setCustomValidity(r);
                                                })(e, o);
                                        }),
                                            t && (t.checked ? r.setAttribute("required", "required") : r.removeAttribute("required"));
                                    })(t, r, o, e);
                                };
                ...
                be.register(["text", "file", "date", "number"], qe),
                    be.register(["text", "password", "email", "color", "tel"], qe, "text"),
                    be.register(["date", "time", "datetime-local"], qe, "date"),
                    be.register(["number", "range"], qe, "number");
                const He = ["value"];
                class ze extends be {
                    static get definition() {
                ...
                function ht(e, t, o) {
                    ...
                    const W = (t, r = !1) => {
                        ...
                        n.name || (n.name = q(n)), r && ["text", "number", "file", "date", "select", "textarea", "autocomplete"].includes(n.type) && (n.className = n.className || "form-control");
                            ...
                            i = ((e) => {
                                const t = ["required", "label", "description", "placeholder", "className", "name", "access", "value"],
                                    ...
                                    o = {
                                        ...
                                        hidden: ["name", "value", "access", "className"],
                    ...
                    if (
                        (A.on("click touchstart", ".grid-button", (e) => {
                            e.preventDefault();
                            const t = o(e.target).parents(".form-field:eq(0)").attr("id");
                            (Le = o(document.getElementById(t))), (Re = e.pageX), (Ie = e.pageY), (Me = 0), qe();
                        }),
                        A.on("wheel", function (e) {
                            if (0 !== e.originalEvent.deltaY && Pe) {
                                ...
                                b.syncBootstrapColumnWrapperAndClassProperty(Le.attr("id"), l), Le.attr("manuallyChangedDefaultColumnClass", !0), He(), b.toggleHighlight(Le);
                            }
                        }),
                        ...
                        o(document).mousemove((e) => {
                            Pe && b.getDistanceBetweenPoints(Re, Ie, e.pageX, e.pageY) > c.opts.cancelGridModeDistance && qe(!1);
                        }),
